    ...
    <div className='w-full h-full'>
      <div className="h-[100vh] w-full">
        <div className="relative h-[100vh] w-full flex">
          ...
          <p class="text-[4vw] md:text-[18px] leading-1.2 font-medium text-white">Proceed to $ZK Airdrop</p>
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none" class="w_24px"><path d="M14 24.5C19.799 24.5 24.5 19.799 24.5 14C24.5 8.20101 19.799 3.5 14 3.5C8.20101 3.5 3.5 8.20101 3.5 14C3.5 19.799 8.20101 24.5 14 24.5Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.5 15.1668L14 18.6668M14 18.6668L17.5 15.1668M14 18.6668L14 9.3335" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
          </div>
        </div>
      </div>
    </div>
